...
import { Plus, Edit, Trash2, Download, Upload, FileText, Clock, Eye, Globe, Award, FolderOpen } from 'lucide-react';
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <SmartStatsCard title="Total Ceremonies" value={totalItems} icon={Award} color="primary" moduleType="mou-ceremonies" statType="total" moduleData={stats} loading={loading} />
                ...
                <div className="card-body">
                    <div className="overflow-x-auto">
                        <table className="table table-zebra">
                            ...
                            <tbody>
                                {loading && ceremonies.length === 0 ? <tr><td colSpan={9} className="text-center py-8"><span className="loading loading-spinner loading-md"></span></td></tr> : ceremonies.length === 0 ? <tr><td colSpan={9} className="text-center py-8">No ceremonies found</td></tr> : ceremonies.map((ceremony) => (
                                    <tr key={ceremony._id}>
                                        ...
                                        <td>
                                            <div className="flex gap-2 justify-end">
                                                <button onClick={() => setFilesFor({ _id: ceremony._id, label: ceremony.visitorName || ceremony.university || 'Ceremony' })} className="btn btn-outline btn-sm" title="Files">
                                                    <FolderOpen size={16} />
                                                </button>
                                                {ceremony.driveLink && (
            ...
            <DriveFilesModal
                ...
                moduleSlug="mou-signing-ceremonies"
