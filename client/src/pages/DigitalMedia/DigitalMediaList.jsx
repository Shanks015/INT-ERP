...
import { Plus, Edit, Trash2, Download, Upload, Radio, TrendingUp, Clock, Eye, Hash, X, Search, ExternalLink, FileText, FolderOpen } from 'lucide-react';
                                    ...
                                    <tr key={item._id}>
                                        ...
                                        <td>
                                            <div className="flex gap-2 justify-end">
                                                <button onClick={() => setFilesFor({ _id: item._id, label: item.articleTopic || item.channel || 'Media' })} className="btn btn-outline btn-sm" title="Files">
                                                    <FolderOpen size={16} />
                                                </button>
                                                {item.driveLink && (
