...
const ConferencesList = () => {
    ...
    const handleExportCSV = async () => {
        try {
            const response = await api.get('/conferences/export-csv', { responseType: 'blob' });
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <SmartStatsCard title="Total Conferences" value={totalItems} icon={Users} color="primary" moduleType="conferences" statType="total" moduleData={stats} loading={loading} />
