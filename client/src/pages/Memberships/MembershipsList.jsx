...
import { Plus, Edit, Trash2, Download, Upload, Users2, TrendingUp, Clock, Eye, FileText, Globe, CheckCircle, FolderOpen } from 'lucide-react';
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <SmartStatsCard title="Total Memberships" value={totalItems} icon={Users2} color="primary" moduleType="memberships" statType="total" moduleData={stats} loading={loading} />
                                    ...
                                    <tr key={membership._id}>
                                        ...
                                        <td>
                                            <div className="flex gap-2 justify-end">
                                                <button onClick={() => setFilesFor({ _id: membership._id, label: membership.name || 'Membership' })} className="btn btn-outline btn-sm" title="Files">
                                                    <FolderOpen size={16} />
                                                </button>
