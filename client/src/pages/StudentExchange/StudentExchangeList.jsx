    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <SmartStatsCard title="Total Exchanges" value={totalItems} icon={UserCheck} color="primary" moduleType="student-exchange" statType="total" moduleData={stats} loading={statsLoading} />
