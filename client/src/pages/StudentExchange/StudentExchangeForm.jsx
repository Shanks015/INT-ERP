...
const StudentExchangeForm = () => {
    ...
    const [formData, setFormData] = useState({ direction: '', studentName: '', exchangeUniversity: '', course: '', semesterYear: '', exchangeStatus: '' });
    ...
    const fetchItem = async () => {
        try {
            ...
            setFormData({ direction: item.direction || '', studentName: item.studentName || '', exchangeUniversity: item.exchangeUniversity || '', course: item.course || '', semesterYear: item.semesterYear || '', exchangeStatus: item.exchangeStatus || '' });
        } catch (error) {
