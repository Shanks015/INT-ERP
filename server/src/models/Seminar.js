...
// Guest Lecture / Seminar module. Split from the combined CampusVisit collection so
// seminar / guest-lecture activity is tracked independently. Cloned from CampusVisit
// with `type` pinned to 'Seminar'.
